...
with data:
    ...
    #read in the data
    df = pd.read_pickle("data/data_for_streamlit2.pkl")
    st.write(df)
...
with recommender1:
    ...
    #read in the data
    df_rec = pd.read_pickle("data/GloVe_embedding_for_recommendation2.pkl")
    
    #function for book recommendation based on similarity of book summary
